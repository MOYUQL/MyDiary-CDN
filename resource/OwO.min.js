						...
						for (var _i = 0; _i < opackage.length; _i++) {
							if (type == "image") {
								...
								if(opackage[_i].icon.substr(0, 4) == "http"){
                                    ...
                                    html += '\n<li class="OwO-item" data-id="' + opackage[_i].data + '">' + '<img class="OwO-item-owo lazyload" src="' + defaultOwO + '" data-src="/usr/themes/MyDiary/local/stickers/' + opackage[_i].icon + '"/>' + '</li>';
                                }
							} else {
